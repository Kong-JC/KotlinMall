...
class HeaderBar @JvmOverloads constructor(context: Context, attrs
: AttributeSet? = null, defStyleAttr: Int = 0) : FrameLayout(context, attrs, defStyleAttr) {
    ...
    private fun initView() {
        ...
        mLeftIv.onClick { if (context is Activity) (context as Activity).finish() }
    }

    fun getLeftView(): ImageView = mLeftIv
    fun getTitleView(): TextView = mTitleTv
